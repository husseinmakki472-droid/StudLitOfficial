  ...
  return (
    <section id="pricing" style={{ position: 'relative', zIndex: 1, maxWidth: 520, margin: '0 auto', padding: '0 28px 96px', textAlign: 'center' }}>
      ...
      <h2 style={{
        ...
        fontSize: 'clamp(26px,3.5vw,40px)', color: '#f0efff',
        letterSpacing: '-1px', marginBottom: 10,
      }}>
        Simple pricing.
      </h2>
      <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 15, color: 'rgba(240,239,255,0.4)', marginBottom: 36 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'center', gap: 4, marginBottom: 4 }}>
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 22, fontWeight: 700, color: 'rgba(240,239,255,0.5)', paddingBottom: 8 }}>$</span>
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 68, fontWeight: 900, color: '#f0efff', lineHeight: 1, letterSpacing: '-3px' }}>15</span>
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 15, color: 'rgba(240,239,255,0.35)', paddingBottom: 10 }}>/mo</span>
        </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.09)', marginBottom: 24 }} />

        <ul style={{ listStyle: 'none', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: 13, marginBottom: 28 }}>
          {FEATURES.map(f => (
            <li key={f} style={{ display: 'flex', alignItems: 'center', gap: 11, fontFamily: 'Inter, sans-serif', fontSize: 14, color: 'rgba(240,239,255,0.65)' }}>
              <span style={{
        ...
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 12, color: 'rgba(240,239,255,0.3)', marginTop: 12 }}>
