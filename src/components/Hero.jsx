  ...
  return (
    <section id="home" style={{ position: 'relative', zIndex: 1, padding: '96px 28px 72px', textAlign: 'center', maxWidth: 860, margin: '0 auto' }}>
      ...
      <div className="fade-up-1" style={{
        ...
        color: 'rgba(240,239,255,0.6)', marginBottom: 28,
      }}>
      ...
      <h1 className="fade-up-2" style={{
        ...
        letterSpacing: '-3px', color: '#f0efff', marginBottom: 20,
      }}>
        Study Smarter,<br />
      ...
      <p className="fade-up-3" style={{
        ...
        color: 'rgba(240,239,255,0.55)', maxWidth: 520, margin: '0 auto 36px',
        lineHeight: 1.7,
      }}>
      ...
      <div className="fade-up-4" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, marginBottom: 36, flexWrap: 'wrap' }}>
        ...
        <a
          ...
          style={{
            ...
            color: 'rgba(240,239,255,0.7)', border: '1px solid rgba(255,255,255,0.18)',
            borderRadius: 16, padding: '15px 28px',
            fontFamily: 'Inter, sans-serif', fontSize: 15.5, fontWeight: 500,
            textDecoration: 'none', cursor: 'pointer',
            transition: 'background 0.2s, color 0.2s, border-color 0.2s, transform 0.15s',
          }}
          onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.05)'; e.currentTarget.style.color = '#f0efff'; e.currentTarget.style.borderColor = '#7c5cfc'; e.currentTarget.style.transform = 'translateY(-1px)' }}
          onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = 'rgba(240,239,255,0.7)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.18)'; e.currentTarget.style.transform = 'translateY(0)' }}
        >
          Explore Features
        </a>
      </div>
      ...
      <div className="fade-up-5" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 13.5, color: 'rgba(240,239,255,0.55)' }}>
            <strong style={{ color: '#f0efff' }}>4.9/5</strong> · Loved by <strong style={{ color: '#f0efff' }}>10,000+</strong> students worldwide
          </span>
        </div>
      </div>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={label} style={{ textAlign: 'center' }}>
            <div style={{ fontFamily: 'Inter, sans-serif', fontSize: 24, fontWeight: 800, color: '#f0efff' }}>
              {val}<span style={{ color: '#7c5cfc', fontSize: 16 }}>{sup}</span>
            </div>
            <div style={{ fontFamily: 'Inter, sans-serif', fontSize: 12, color: 'rgba(240,239,255,0.35)', marginTop: 3, letterSpacing: '0.3px' }}>
              {label}
            </div>
          </div>
        ))}
